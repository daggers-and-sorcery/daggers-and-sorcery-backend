...
public class LesserIdentificationPageEntry extends SpellPageEntry {
    ...
    public CharacterRefreshResponse build(PageEntryDataContainer pageEntryDataContainer) {
        ...
        List<ItemDatabaseEntity> unidentifiedItems = inventory.getItems(IdentificationType.UNIDENTIFIED);
    ...
    private List<Map<String, Object>> convertToResponseItem(SessionEntity httpSession, List<ItemDatabaseEntity> unidentifiedItems) {
