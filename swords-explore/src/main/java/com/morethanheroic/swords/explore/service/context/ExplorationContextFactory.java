...
public interface ExplorationContextFactory {
    ...
    ExplorationContext newExplorationContext(final UserEntity userEntity, final SessionEntity sessionEntity, ExplorationEventLocationType location, int nextStage);
}
