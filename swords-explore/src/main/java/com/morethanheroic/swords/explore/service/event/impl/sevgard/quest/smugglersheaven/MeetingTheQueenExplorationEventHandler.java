...
public class MeetingTheQueenExplorationEventHandler extends ImprovedExplorationEventHandler {
    ...
    private static final int SMUGGLERS_HEAVEN_QUEST_SECOND_COMBAT_STAGE_ID = 4;
    private static final int SMUGGLERS_HEAVEN_QUEST_NEXT_STAGE_ID = 5;
        ...
        return explorationResultStageBuilderFactory.newBuilder()
                .addStage(STARTER_STAGE,
                        explorationResultBuilder1 -> explorationResultBuilder1
                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_3")
                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_4")
                                .newCombatEntry(VAMPIRE_WARRIOR_ID, questDefinitionCache.getDefinition(SMUGGLERS_HEAVEN_QUEST_ID), SMUGGLERS_HEAVEN_QUEST_FIRST_COMBAT_STAGE_ID)
                                .build()
                )
                .addStage(FIRST_COMBAT_STAGE,
                        explorationResultBuilder1 -> explorationResultBuilder1
                                ...
                                .isFailure(
                                        explorationResultBuilder2 -> explorationResultBuilder2
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_5")
                                                .newCombatEntry(VAMPIRE_WARRIOR_ID, questDefinitionCache.getDefinition(SMUGGLERS_HEAVEN_QUEST_ID), SMUGGLERS_HEAVEN_QUEST_SECOND_COMBAT_STAGE_ID)
                                                .build()
                                )
                                .build()
                )
                .addStage(SECOND_COMBAT_STAGE,
                        explorationResultBuilder1 -> explorationResultBuilder1
                                ...
                                .isFailure(
                                        explorationResultBuilder2 -> explorationResultBuilder2
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_6")
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_7")
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_8")
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_9")
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_10")
                                                .newMessageEntry("SMUGGLERS_HEAVEN_QUEST_EXPLORATION_EVENT_ENTRY_11")
