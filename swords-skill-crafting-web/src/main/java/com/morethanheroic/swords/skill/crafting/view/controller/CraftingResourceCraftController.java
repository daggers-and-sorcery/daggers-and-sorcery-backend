...
import com.morethanheroic.swords.skill.crafting.view.request.domain.CraftingResourceCraftRequest;
...
public class CraftingResourceCraftController {
    ...
    @PostMapping("/skill/crafting/resource/craft")
    public Response craft(final UserEntity userEntity, @RequestBody @Valid final CraftingResourceCraftRequest craftingCraftRequest) {
