...
public class AttributeCalculatorTest {
    ...
    public void testCalculateAttributeValue() {
        ...
        AttributeData attributeDataStrength = attributeCalculator.calculateAttributeValue(user, GeneralAttribute.STRENGTH);
        ...
        AttributeData attributeDataLife = attributeCalculator.calculateAttributeValue(user, CombatAttribute.LIFE);
