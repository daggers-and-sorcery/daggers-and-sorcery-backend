...
public class ManaCombatSettings extends CombatSettingsAction {
    ...
    public ManaCombatSettings(UseItemService useItemService, ItemDefinitionManager itemDefinitionManager, UseSpellService useSpellService, SpellDefinitionManager spellDefinitionManager) {
