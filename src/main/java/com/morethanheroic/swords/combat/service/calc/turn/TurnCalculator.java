...
public class TurnCalculator {
    ...
    @Autowired
    public TurnCalculator(GlobalAttributeCalculator globalAttributeCalculator, MonsterAttackCalculator monsterAttackCalculator, PlayerAttackCalculator playerAttackCalculator) {
